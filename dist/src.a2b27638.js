 ...
 */
var createImcompleteList = function createImcompleteList(text) {
  // 未完了タスクに挿入するHTMLを作成
  ...
  completeButton.addEventListener("click", function () {
    ...
    undoButton.addEventListener("click", function () {
      var undoTarget = undoButton.parentNode.parentNode;
      document.getElementById("complete_records").removeChild(undoTarget);
      var completeTitle = undoTarget.querySelector(".record").innerText;
 ...
 * @param target (HTML)
 */
var deleteFromImcomplete = function deleteFromImcomplete(target) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "43147" + '/');
